...
Style: STYLE2,${font2},${size2},${color2Primary},${color2Primary},&H00000000,${shadowColor},${weight2},${italic2},0,0,100,100,0,0,1,${outline},${shadow},${CENTER_ALIGNMENT_MODE},${CENTER_MARGIN_L},0,${marginV_Line2},1
Style: STYLE1,${font1},${size1},${color1Primary},${color1Primary},&H00000000,${shadowColor},${weight1},${italic1},0,0,100,100,0,0,1,${outline},${shadow},${CENTER_ALIGNMENT_MODE},${CENTER_MARGIN_L},0,${marginV_Line1},1
...
`;
  ...
  const getPlainText = (lineText) => {
    // Allows manual line breaks \N, but does not interfere with spacing.
