...
// ⭐ FIX: Reverted the use of \h (non-breaking space) as it interferes with wrapping.
// We rely purely on:
// 1. Alignment 2 (Bottom Center) in the Style.
// 2. MarginV_Line1 > MarginV_Line2 for correct vertical order.
// 3. Separate Dialogue entries for each line.
...
`;
  ...
  const getPlainText = (lineText) => {
    // Allows manual line breaks \N, but removes complex tags like \h that interfere with Alignment 2
...
app.post('/render', async (req, res) => {
  ...
  try {
    ...
    const WATERMARK_IMAGE_HEIGHT = 28; // Set to 28px as requested
